...
After the cosmic ray data collection periods, the magnetic field was turned off again due to problems with the cryogenic system, and the first collisions were detected with $B=0$T. This change in the magnetic field expectedly caused movements in the tracking system. The effect is the strongest in the pixel subdetectors. The alignment performed using~$B=0$T collisions and cosmic ray data recovers the tracker performance in reconstructing kinematic parameters of charged particles. When the magnetic field was turned back on, the large substructures of BPIX and FPIX have been displaced again, and, thus, the tracking system was aligned again to recover these displacements.  

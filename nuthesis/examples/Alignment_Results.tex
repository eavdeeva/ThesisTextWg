...
\end{itemize}
\noindent{Only $pp$ collision data at $B=3.8$T are used for physics measurements and the three other periods are preliminary. During the preliminary periods we make sure that all parts of the detector work properly and also perform the preliminary alignment of the tracking system. Periods of $pp$ collisions are interfilled with cosmic ray data-taking when LHC does not provide any collision data. This interfill cosmic ray data are also used for the tracker alignment. }

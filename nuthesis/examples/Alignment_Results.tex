...
\begin{itemize}
  \item include geometry comparison tool (Ch.~\ref{sec:AlRes_GCP});
...
\end{itemize}
\noindent{Full results of the first alignment with Run~II data are available at~\cite{ref_AlApproved_twiki}}.

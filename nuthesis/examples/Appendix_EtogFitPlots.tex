...
Fit plots of electron-photon invariant mass $M_{e\gamma}$ distributions for the $e \rightarrow \gamma$ data-driven estimation in the electron channel. The procedure of the background estimation is described in Ch.~\ref{sec:BackgroundSubtraction_etog}.

...
\include{Appendix_ZgFSRandISRplots}
\include{Appendix_CompareTemplatesPlots}
\include{Appendix_TemplateFitPlots}
\include{Appendix_MCclosureCheck}
\include{Appendix_TemplateFitPlotsMCclosure}
\include{Appendix_TemplateFitPlotsMCclosureWjestPlusWg}
\include{Appendix_EtogFitPlots}
\include{Appendix_EtogFitPlotsNoWMtCut}
\include{Appendix_EtogTables}
\include{Appendix_Mpholep1DatavsMCPlots}
\include{Appendix_CorrelationMatrices}
\include{Appendix_Code}
\include{Appendix_ZgCheck}

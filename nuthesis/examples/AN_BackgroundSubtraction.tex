...
The fits are performed in an extended, maximum likelihood manner, separately in each $P_T^\gamma$ bin in fine $\eta^\gamma$ binning. The $\eta^\gamma$ binning for different $P_T^\gamma$ ranges is chosen to be:
     \begin{itemize}
        \item for $P_T^\gamma$ ranges $15-20-25-30-35-45-55-65$~GeV:
           \begin{itemize}
              \item $\eta^\gamma$ binning in barrel: $0.00-0.10-0.50-1.00-1.44$;
              \item $\eta^\gamma$ binning in endcap: $1.56-2.10-2.20-2.40-2.50$;
           \end{itemize}
        \item for $P_T^\gamma$ ranges $65-75-85-95$~GeV:
          \begin{itemize}
              \item $\eta^\gamma$ binning in barrel: $0.00-0.50-1.44$;
              \item $\eta^\gamma$ binning in endcap: $1.56-2.20-2.50$;
           \end{itemize}
        \item for $P_T^\gamma$ ranges $95-120-500$~GeV:
          \begin{itemize}
              \item $\eta^\gamma$ binning in barrel: $0.00-1.44$;
              \item e$\eta^\gamma$ binning in ndcap: $1.56-2.50$;
           \end{itemize}
        \item for $P_T^\gamma$ range $10-15$~GeV (underflow bin): no fits performed, MC-based prediction is used.
     \end{itemize}

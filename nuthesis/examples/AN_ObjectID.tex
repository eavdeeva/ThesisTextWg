...
\begin{figure}[htb]
  ...
  \caption{$P_T^{\gamma}$ distribution of $W\gamma$ candidates. Data vs total MC. Left column: muon channel, right column: electron channel. EB (top) and EE (bottom) photons. The ratio plot is data divided by total MC. }
  \label{fig:DATAvsMC}
  \end{center}
\end{figure}

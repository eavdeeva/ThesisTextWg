...
This Appendix contains the results of the two MC-based closure cross checks discussed in Ch.~\ref{sec:AN_BackSubtr_Closure}. The results of the MC closure check with the pseudodata prepared by mixing $W\gamma$ and $W$+jets samples are shown in Fig.~\ref{fig:TrueDDvsMC_MCclosureWjetsPlusWg}-\ref{fig:FakeDDvsMC_MCclosureWjetsPlusWg}. The results of the MC realistic check with the pseudodata prepared by mixing several MC samples, are shown in Fig.~\ref{fig:DATAvsBKGandSIGMC_MCclosure_MUON_B}-\ref{fig:DATAvsBKGandSIGMC_MCclosure_ELECTRON_E}.

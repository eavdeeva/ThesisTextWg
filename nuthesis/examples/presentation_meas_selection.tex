\begin{frame}\frametitle{Event-Level Selection Requirements}
...
%\begin{figure}[htb]
%  \begin{center}
%   \includegraphics[width=0.5\textwidth]{../figs/figs_v11/MUON_ZGamma/PrepareYields/c_TotalDATAvsMC_EtaCommon__nVtx_noPU.png}\includegraphics[width=0.5\textwidth]{../figs/figs_v11/MUON_ZGamma/PrepareYields/c_TotalDATAvsMC_EtaCommon__nVtx.png}

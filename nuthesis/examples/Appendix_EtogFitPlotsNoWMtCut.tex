% APPENDIX
\chapter{Fit Plots of $M_{e\gamma}$ without Requirement on $M_T^W$}
\label{sec:EtogammaFitPlotsNoWMtCut}

This appendix provides fit plots of the electron-photon invariant mass $M_{e\gamma}$ of $W\gamma\rightarrow ee\gamma$-selected data prior $M_T^W$ and $M_{e\gamma}$ requirements applied. These fit results are used for the estimation of the systematic uncertainty related to possible bias in fit machinery and template shapes in the procedure of the $e \rightarrow \gamma$ background estimation in the electron channel. The procedure of the background estimation is described in Ch.~\ref{sec:BackgroundSubtraction_etog}, the procedure of the estimation of the systematic uncertainty is described in Ch.~\ref{sec:Systematics_OtherSources}.

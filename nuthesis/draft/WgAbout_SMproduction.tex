...
The W$\gamma$ process is represented by four LO Feynman diagrams with three vertices each. The W$\gamma$ process amplitude and cross section are long, comlicated expressions, therefore, they are not quoted in this dissertation. The first calculation of the W$\gamma$ process with necessary formulas can be found in~\cite{ref_theory_LO}.\\

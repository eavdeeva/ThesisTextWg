...
\noindent{where $W_{fi}$ is a transition probability between final and initial states of the system per unit spacial volume, $F$ is the initial flux, and $N_{fs}$ is the density of final states~\cite{ref_Halzen_Martin}, chapter~4.3.}\\ 

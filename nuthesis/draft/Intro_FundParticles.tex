...
All fundamental elementary particles in the SM can be split into three categories by their spins. There are fermions which possess spin s=1/2, there are gauge bosons which are also called force mediators are vector particles (s=1) and there is the Higgs boson which is a scalar particle (s=0). \\

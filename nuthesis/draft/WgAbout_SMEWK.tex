...
Writing $\tilde{W}_\mu$ in Eq.~\ref{eq:L_gauge_kin} explicitly, we obtain triple gauge coupling (TGC) and quartic gauge coupling (QGC) coupling terms:\\ 
...
In the measurement of this dissertation we probe $WW\gamma$ coupling (Eq.~\ref{eq:L_TGC_2_2}).\\

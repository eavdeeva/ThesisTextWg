...
The measurement in this dissertation provides a test for the electroweak sector of the SM. Thus, we will retrace the steps of the derivation of the EWK part of the SM Lagrangian starting from Lagrangians of free particles. The resulting Lagrangian accommodates electroweak gauge bosons including their self-couplings which are the primary focus of our measurement.\\
...
Writing $\tilde{W}_\mu$ in Eq.~\ref{eq:L_gauge_kin} explicitly, we will get TGC and QGC coupling terms:\\ 

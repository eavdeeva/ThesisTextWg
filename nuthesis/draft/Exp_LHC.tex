...
There are many other collider parameters which are not discussed in this dissertation. A brief summary of the most important of them is available in Tab. \ref{tab:LHCparameters}.\\

The measurement of this dissertation is performed at the energy of~4~TeV per beam or at the center of mass energy $\sqrt{s}=8$~TeV using 19.6~fb$^{-1}$ of data. Previous measurements of the same process were done at $\sqrt{s}=7$~TeV with about four times less amount of data by both CMS and ATLAS. These measurements are discussed in greater details in Ch.~\ref{sec:WgAbout_PastMeas}.\\
